...
class StudentResourceIT {
    ...
    private static final String DEFAULT_ATTENDANT_NAME = "AAAAAAAAAA";
    private static final String UPDATED_ATTENDANT_NAME = "BBBBBBBBBB";

    private static final String DEFAULT_KIN = "AAAAAAAAAA";
    private static final String UPDATED_KIN = "BBBBBBBBBB";
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().attendantName(DEFAULT_ATTENDANT_NAME).kin(DEFAULT_KIN);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().attendantName(UPDATED_ATTENDANT_NAME).kin(UPDATED_KIN);
        return student;
    }
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getAttendantName()).isEqualTo(DEFAULT_ATTENDANT_NAME);
        assertThat(testStudent.getKin()).isEqualTo(DEFAULT_KIN);
    }
    ...
    @Test
    @Transactional
    void checkAttendantNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setAttendantName(null);
    ...
    @Test
    @Transactional
    void checkKinIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setKin(null);
    ...
    void getAllStudents() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.[*].attendantName").value(hasItem(DEFAULT_ATTENDANT_NAME)))
            .andExpect(jsonPath("$.[*].kin").value(hasItem(DEFAULT_KIN)));
    }
    ...
    void getStudent() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.attendantName").value(DEFAULT_ATTENDANT_NAME))
            .andExpect(jsonPath("$.kin").value(DEFAULT_KIN));
    }
    ...
    void putNewStudent() throws Exception {
        ...
        updatedStudent.attendantName(UPDATED_ATTENDANT_NAME).kin(UPDATED_KIN);
        ...
        Student testStudent = studentList.get(studentList.size() - 1);
        assertThat(testStudent.getAttendantName()).isEqualTo(UPDATED_ATTENDANT_NAME);
        assertThat(testStudent.getKin()).isEqualTo(UPDATED_KIN);
    }
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.attendantName(UPDATED_ATTENDANT_NAME).kin(UPDATED_KIN);
