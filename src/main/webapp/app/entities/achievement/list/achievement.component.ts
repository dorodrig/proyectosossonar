...
export class AchievementComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.achievementService
      ...
      .subscribe({
        next: (res: HttpResponse<IAchievement[]>) => {
  ...
  trackId(_index: number, item: IAchievement): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IAchievement[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
