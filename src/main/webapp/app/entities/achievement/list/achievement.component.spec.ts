...
describe('Achievement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'achievement', component: AchievementComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.achievements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
